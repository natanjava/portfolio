...
<html lang="en">
<head>
	<title>Natanael-Portfolio</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100" style="width: 500px;">
				<form class="login100-form validate-form" >
					...
					<span class="login100-form-title p-b-34 p-t-27">
						<a href="http://www.natanaelbonfim.com/home" 
						   target="_blank" class="login100-form-title p-b-34 p-t-27">
						   Natanael Bonfim 
						</a>
						<br/> <div class="">Java Developer 
						<br/> 6 Model Projects</div>
					</span>		
			       
			       	<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="#">
							1 - ONLINE SHOP (building...) <br> HTML/CSS/Javascript + Spring MVC
						</button>
					</div>
					<br>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="window.open('http://www.natanaelbonfim.com/JSF-intro/','_blank')">
							2 - ORDERS REGISTRATION SYSTEM <br> JSF + Hibernate + BootFaces
						</button>
					</div>
					<br>
					<div class="container-login100-form-btn" onclick="window.open('http://www.natanaelbonfim.com/springboot-thymeleaf/login','_blank')">
						<button class="login100-form-btn">
							3 - CRUD SYSTEM <br> Spring BOOT + Thymeleaf
						</button>
					</div>
					<br>
